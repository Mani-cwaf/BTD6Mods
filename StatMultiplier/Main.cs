...
namespace StatMultiplier
{
	public class StatMultiplierClass : BloonsTD6Mod
    {
        ...
        {
            displayName = "Cash Multiplier (Min 0.1 Max 100)",
            minValue = 0.1,
            maxValue = 100.0,
            isSlider = false
        };
        ...
        {
            displayName = "Damage Multiplier (Min 0.1 Max 100)",
            minValue = 0.1,
            maxValue = 100.0,
            isSlider = false
        };
        ...
        {
            displayName = "Attack Speed Multiplier (Min 0.1 Max 100)",
            minValue = 0.1,
            maxValue = 100.0,
            isSlider = false
        };
        ...
        {
            displayName = "Pierce Multiplier (Min 0.1 Max 100)",
            minValue = 0.1,
            maxValue = 100.0,
            isSlider = false
        };
        ...
        {
            displayName = "Range Multiplier (Min 0.1 Max 100)",
            minValue = 0.1,
            maxValue = 100.0,
            isSlider = false
        };
